...
public class POSUtil {
    ...
    /*
     * Convert hex values to ascii code
     **/
...
//		result[1] = (byte)((i >> 16) & 0xFF);
    ...
    public static String xor16(byte[] src1, byte[] src2){
        ...
        return POSUtil.byteArray2Hex(results);
    }
...
//       long MAX_VALUE = 0x7fffffffffffffffL;
    ...
    public static String getAPVersion(){
        ...
        try {
            ...
            serial = (String)get.invoke(c, "ro.product.internal_version");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return serial;
    }
    public static String getMobileDeviceSN(){
        String serial = null;
        try {
            Class<?> c =Class.forName("android.os.SystemProperties");
            Method get =c.getMethod("get", String.class);
            serial = (String)get.invoke(c, "net.hostname");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return serial;
    ...
    public static String getDeviceMiei1() {
        String imei1 = null;
        Class<?> c = null;
        try {
            c = Class.forName("android.os.SystemProperties");
            Method get = c.getMethod("get", String.class);
            imei1 = (String) get.invoke(c, "gsm.mtk.imei1");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return imei1;
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    public static String getDeviceMiei2() {
        String imei2 = null;
        Class<?> c = null;
        try {
            c = Class.forName("android.os.SystemProperties");
            Method get = c.getMethod("get", String.class);
            imei2 = (String) get.invoke(c, "gsm.mtk.imei2");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return imei2;
    ...
    public static byte[] shuffleByteArray(byte[] data) {
        // 将 byte[] 转为 List<Byte>
        ...
        // 转回 byte[]
        byte[] shuffled = new byte[list.size()];
